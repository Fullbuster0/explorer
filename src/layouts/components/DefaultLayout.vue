    ...
    >
      <div class="flex justify-between mt-1 pl-4 py-4 mb-1">
        <RouterLink to="/" class="flex items-center">
          <img class="w-10 h-10" src="../../assets/logo.svg" alt="Shazoes" />
          <h1 class="flex-1 ml-3 text-2xl font-semibold dark:text-white">Shazoes</h1>
        </RouterLink>
        <div
      ...
      <div class="px-2">
        ...
        >
          <Icon icon="mdi:server" class="text-xl mr-2" />
          <div class="text-base capitalize flex-1 text-gray-600 dark:text-gray-200">Services</div>
        </a>
      </div>
    </div>
